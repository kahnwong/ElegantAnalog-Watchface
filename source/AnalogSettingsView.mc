...
class AnalogSettingsView extends WatchUi.View {
    ...
    public function initialize() {
        ...
        System.println("AnalogSettingsView initialize...");
    }
    ...
    public function onShow() as Void {
        ...
        */
        ...
        if (firstShow) {
            ...
            //WatchUi.switchToView(new $.AnalogSettingsMenu(), new $.AnalogSettingsMenuDelegate(), WatchUi.SLIDE_IMMEDIATE);
            //WatchUi.pushView(new $.AnalogSettingsMenu(), new $.AnalogSettingsMenuDelegate(), WatchUi.SLIDE_IMMEDIATE);
